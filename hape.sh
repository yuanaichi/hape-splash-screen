...
echo "   __   __  _______  _______  _______    _______  _______  _______  _______  _______   "
echo "   |  | |  ||   _   ||       ||       |  |  _    ||       ||   _   ||       ||       |"
echo "   |  |_|  ||  |_|  ||    _  ||    ___|  | |_|   ||    ___||  |_|  ||  _____||_     _|"
echo "   |       ||       ||   |_| ||   |___   |       ||   |___ |       || |_____   |   |"
echo "   |       ||       ||    ___||    ___|  |  _   | |    ___||       ||_____  |  |   |"
echo "   |   _   ||   _   ||   |    |   |___   | |_|   ||   |___ |   _   | _____| |  |   |"
echo "   |__| |__||__| |__||___|    |_______|  |_______||_______||__| |__||_______|  |___|"
...
neofetch --ascii ./ascii_hape --ascii_colors 1 2 3 4 5 6
exit 0
